...
#SBATCH -A unikoeln
echo "bismark_genome_preparation --bowtie2 --parallel 24 /projects/ccg-ngs/production/public/species/lambda/"
# Input
echo "activate conda"
...
bismark_genome_preparation --bowtie2 --parallel 24 /projects/ccg-ngs/production/public/species/lambda/
